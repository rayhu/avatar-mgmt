export default {
  ...
  animate: {
    ...
    ssmlGenerationError: 'SSML generation failed',
    voice: 'Voice',
    ...
    actions: {
      ...
      daoqian: 'Apology',
      compare: 'Compare',
      explainDistance: 'Explain Distance',
      emphasize: 'Emphasize',
      point: 'Point',
  ...
  modelManagement: {
    ...
    uploadPlaceholder: {
      glb: 'Click or drag GLB/GLTF files to this area',
      preview: 'Click or drag preview image to this area',
    },
    uploadHint: {
      glb: 'Supports .glb and .gltf formats, max 50MB',
      preview: 'Supports JPG, PNG and other image formats, max 10MB',
    },
    uploading: 'Uploading...',
    noModelsAvailable: 'No Models Available',
    noModelsDescription:
      'There are currently no ready models available for use. Please contact the administrator to add models or try again later.',
  },
  test: {
